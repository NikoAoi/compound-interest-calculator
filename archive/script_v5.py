...
class VisualCompoundInterestCalculator(ctk.CTk):
    ...
    def _get_plot_colors(self):
        if ctk.get_appearance_mode() == "Dark":
            return {"bg_color": "#2b2b2b", "text_color": "#dce4ee", "spine_color": "#565b5e", "grid_color": "#343638", "line_color": "#1f77b4"}
        else:
            return {"bg_color": "#f0f0f0", "text_color": "#1c1c1c", "spine_color": "#565b5e", "grid_color": "#d6d6d6", "line_color": "#1f77b4"}
    ...
    def update_plot(self, *args):
        ...
        if last_day > 0 and last_day % step != 0:
